...
\begin{document}
    ...
    \begin{abstract}
En la formación de los estudiantes de ingeniería eléctrica es escencial el estudio de máquinas síncronas, por ende se realizó una práctica centrada en el análisis del generador síncrono y la conexión de este con la red eléctrica. Este proceso se ve reflejado en aplicaciones reales, donde la sincronización de generadores asegura la estabilidadd, eficiencia y confiabilidad del sistema eléctrico.


 Inicialmente, se observó el comportamiento del sistema cuando el generador entregaba y absorbía potencia, para ello, se midió la potencia activa y reactiva bajo los escenarios mencionados anteriormente. Luego, para poder analizar la distribución de potencias entre los generadores, se hizo el reparto de potencias P y Q, modificando la carga y ajustando el sistema.
    \end{abstract}


    \input{GS a la redcontend.tex}
