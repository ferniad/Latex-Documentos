...
\input{1mer avance dai.tex}
\input{1mer avance carlitos.tex}
\input{1mer avance descripcion.tex}
\input{1mer avance maletina criterios.tex}
\input{1mer avance parteB.tex}
\input{1mer avance conclusiones.tex}
