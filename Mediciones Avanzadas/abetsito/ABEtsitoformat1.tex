...
\input{primeraentrega.tex}

% Ejemplo de cita para evitar errores de compilación
Como se muestra en~\cite{Jaramillo-RamírezOlmesCamilo2022SdMd}, el sistema propuesto es efectivo.

\bibliographystyle{IEEEtran}
\bibliography{refabetsito}
